  ...
  return (
    ...
    <div className="container.fluid p-5 ">
        <div className="row flex-wrap" >
            ...
            <div className="col-lg-7 col-12"  style={{backgroundColor:"pink", textAlign:"center", paddingTop:"100px", height:"500px"}}>
        ...
        <div className="rogelio col-lg-5 col-12 "  >
            <img src={image} style={{borderRadius: "50%", height: "50%" }} alt=""/>
            {/* <img src={image} style={{borderRadius: "50%", height: "50%" }} alt=""/>
            <img src={image} style={{borderRadius: "50%", height: "50%" }} alt=""/> */}
            </div>
        </div>
